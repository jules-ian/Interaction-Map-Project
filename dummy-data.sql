...
VALUES
    ('14e8f8c3-1537-40d5-bb5a-1d90d7d9c500', 'Johns Clinic', 'Hospital', 'Private', '123 Medical St', 'Cityville', '12345', 0917837489, 'johnsclinic@example.com', 'John Doe', 'Owner', 0173647283, 'john.doe@example.com', 45.123, 15.456, 'A leading medical clinic in Cityville', '2023-12-19T12:34:56', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 0 ROWS FETCH NEXT 1 ROW ONLY)),
    ('2747c3a4-1f79-4f1b-8525-c1a54b17224a', 'Tech Solutions Inc.', 'Technology', 'Corporate', '456 Tech Blvd', 'Tech City', '54321', 0776283945, 'techsolutions@example.com', 'Jane Smith', 'IT Manager', 0917628934, 'jane.smith@example.com', 46.789, 16.123, 'Providing cutting-edge technology solutions', '2023-12-19T13:45:00', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY)),
    ('3d7d9eb3-aa53-4e8c-8ee7-b8ac511f8c8a', 'Green Thumb Landscapes', 'Landscaping', 'Small Business', '789 Green St', 'Naturetown', '67890', 0862777381, 'greenthumb@example.com', 'Sam Green', 'Landscaper', 0617890273, 'sam.green@example.com', 47.111, 17.222, 'Creating beautiful landscapes for homes and businesses', '2023-12-19T14:56:23', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('ac6e46a3-c36a-4c54-bc17-689fe29f450b', 'Healthy Smiles Dental', 'Dental Clinic', 'Private', '789 Dentist Ave', 'Toothville', '56789', 0912345678, 'healthysmiles@example.com', 'Dr. Sarah Johnson', 'Dentist', 0123456789, 'sarah.johnson@example.com', 48.567, 14.890, 'Providing top-notch dental care in Toothville', '2023-12-19T15:45:00', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('dd1f3985-38fc-4ba3-80c0-67b987b33257', 'Tech Innovators Ltd.', 'IT Services', 'Startup', '101 Innovator St', 'Techland', '12345', 0987654321, 'techinnovators@example.com', 'Alex Turner', 'CEO', 0765432109, 'alex.turner@example.com', 46.112, 15.789, 'Innovating the future with cutting-edge technology', '2023-12-19T16:34:12', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('1a390e1a-6626-4e27-925b-9d349ab475e4', 'Blossom Gardens Nursery', 'Landscaping', 'Small Business', '456 Bloom St', 'Gardentown', '34567', 0654321098, 'blossomgardens@example.com', 'Emily Green', 'Botanist', 0789012345, 'emily.green@example.com', 49.321, 16.543, 'Specializing in beautiful garden designs and plant care', '2023-12-19T17:23:45', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY)),
    ('f8a0e89d-3f8d-489e-8394-b59445c7e865', 'City Gym & Fitness', 'Fitness Center', 'Private', '987 Fit St', 'Workout City', '87654', 0932109876, 'citygym@example.com', 'Chris Fitness', 'Owner', 0654321098, 'chris.fitness@example.com', 47.890, 18.123, 'Your ultimate destination for fitness and health', '2023-12-19T18:12:34', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 0 ROWS FETCH NEXT 1 ROW ONLY)),
    ('f824ce77-5b1a-4c6a-9151-bb1da1a704ac', 'Sunrise Pharmacy', 'Pharmacy', 'Independent', '567 Health Blvd', 'Medtown', '98765', 0908765432, 'sunrisepharmacy@example.com', 'Lisa Davis', 'Pharmacist', 0123456789, 'lisa.davis@example.com', 46.789, 14.567, 'Your trusted neighborhood pharmacy', '2023-12-19T19:01:23', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY)),
    ('c648be6a-36e9-419c-9f79-14fe7b864c6d', 'Slick Design Studios', 'Design Agency', 'Creative', '234 Creativity Lane', 'Artville', '23456', 0765432109, 'slickdesigns@example.com', 'Mark Foster', 'Creative Director', 0987654321, 'mark.foster@example.com', 47.890, 15.789, 'Transforming ideas into visually stunning designs', '2023-12-19T19:50:45', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('e0af09ec-7ad6-4c27-b146-b0cc194a9cb3', 'Green Living Landscapes', 'Landscaping', 'Small Business', '789 Eco St', 'Green City', '34567', 0654321098, 'greenliving@example.com', 'Anna Green', 'Landscape Architect', 0789012345, 'anna.green@example.com', 48.321, 16.543, 'Creating sustainable and beautiful outdoor spaces', '2023-12-19T20:40:01', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('6f6262b1-4291-4aa9-8ba5-1e8a0e9e7163', 'FitFuel Nutrition', 'Nutritionist', 'Private', '876 Nutrient Ave', 'Healthtown', '87654', 0932109876, 'fitfuelnutrition@example.com', 'Mike Turner', 'Nutritionist', 0654321098, 'mike.turner@example.com', 49.890, 17.123, 'Fueling your health with personalized nutrition plans', '2023-12-19T21:30:20', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY)),
    ('d8d33c54-1e87-4ab6-a6a8-6c9269474a4d', 'EcoTech Solutions', 'Environmental Services', 'Green Business', '123 Eco Ave', 'Greenville', '54321', 0912345678, 'ecotech@example.com', 'Emma Green', 'Environmental Specialist', 0123456789, 'emma.green@example.com', 46.789, 15.123, 'Promoting eco-friendly solutions for a sustainable future', '2023-12-19T22:20:12', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 0 ROWS FETCH NEXT 1 ROW ONLY)),
    ('4b6141f8-481c-4eb7-8f5c-aa6e7a6c67b4', 'Pet Paradise Veterinary Clinic', 'Veterinary Clinic', 'Private', '456 Pet Blvd', 'Animaltown', '98765', 0987654321, 'petparadisevet@example.com', 'Dr. James Smith', 'Veterinarian', 0765432109, 'james.smith@example.com', 47.890, 16.789, 'Caring for your pets with passion and expertise', '2023-12-19T23:10:45', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 1 ROWS FETCH NEXT 1 ROW ONLY)),
    ('1d0ed49a-149b-4654-98a5-8f39cfd0abf4', 'Artisan Coffee Roasters', 'Coffee Shop', 'Local Business', '789 Brew St', 'Coffeetown', '23456', 0654321098, 'artisancoffee@example.com', 'Sophie Baker', 'Barista', 0789012345, 'sophie.baker@example.com', 48.321, 17.543, 'Serving handcrafted coffee with love and precision', '2023-12-20T00:01:00', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('2f69b399-c270-4a9b-81fb-64a35421827a', 'Cozy Book Nook', 'Bookstore', 'Independent', '876 Reading Lane', 'Bookville', '87654', 0932109876, 'cozybooknook@example.com', 'David Reader', 'Owner', 0654321098, 'david.reader@example.com', 49.890, 18.123, 'A haven for book lovers and literary enthusiasts', '2023-12-20T01:34:56', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 0 ROWS FETCH NEXT 1 ROW ONLY)),
