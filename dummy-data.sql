...
VALUES
    ...
    ('c648be6a-36e9-419c-9f79-14fe7b864c6d', null, 'Slick Design Studios', 'Design Agency', 'Creative', '234 Creativity Lane', 'Artville', '23456', 0765432109, 'slickdesigns@example.com', 'Mark Foster', 'Creative Director', 0987654321, 'mark.foster@example.com', 43.890, 1.789, 'Transforming ideas into visually stunning designs', '2023-12-19T19:50:45', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('e0af09ec-7ad6-4c27-b146-b0cc194a9cb3', null, 'Green Living Landscapes', 'Landscaping', 'Small Business', '789 Eco St', 'Green City', '34567', 0654321098, 'greenliving@example.com', 'Anna Green', 'Landscape Architect', 0789012345, 'anna.green@example.com', 43.321, 1.543, 'Creating sustainable and beautiful outdoor spaces', '2023-12-19T20:40:01', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ...
    ('1d0ed49a-149b-4654-98a5-8f39cfd0abf4', null, 'Artisan Coffee Roasters', 'Coffee Shop', 'Local Business', '789 Brew St', 'Coffeetown', '23456', 0654321098, 'artisancoffee@example.com', 'Sophie Baker', 'Barista', 0789012345, 'sophie.baker@example.com', 43.615, 1.455, 'Serving handcrafted coffee with love and precision', '2023-12-20T00:01:00', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
