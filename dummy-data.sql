...
VALUES
    ...
    ('3d7d9eb3-aa53-4e8c-8ee7-b8ac511f8c8a', 'Green Thumb Landscapes', 'Landscaping', 'Small Business', '789 Green St', 'Naturetown', '67890', 0862777381, 'greenthumb@example.com', 'Sam Green', 'Landscaper', 0617890273, 'sam.green@example.com', 47.111, 2.222, 'Creating beautiful landscapes for homes and businesses', '2023-12-19T14:56:23', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ...
    ('dd1f3985-38fc-4ba3-80c0-67b987b33257', 'Tech Innovators Ltd.', 'IT Services', 'Startup', '101 Innovator St', 'Techland', '12345', 0987654321, 'techinnovators@example.com', 'Alex Turner', 'CEO', 0765432109, 'alex.turner@example.com', 46.112, 0.789, 'Innovating the future with cutting-edge technology', '2023-12-19T16:34:12', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ...
    ('f8a0e89d-3f8d-489e-8394-b59445c7e865', 'City Gym & Fitness', 'Fitness Center', 'Private', '987 Fit St', 'Workout City', '87654', 0932109876, 'citygym@example.com', 'Chris Fitness', 'Owner', 0654321098, 'chris.fitness@example.com', 40.890, 1.123, 'Your ultimate destination for fitness and health', '2023-12-19T18:12:34', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ...
    ('c648be6a-36e9-419c-9f79-14fe7b864c6d', 'Slick Design Studios', 'Design Agency', 'Creative', '234 Creativity Lane', 'Artville', '23456', 0765432109, 'slickdesigns@example.com', 'Mark Foster', 'Creative Director', 0987654321, 'mark.foster@example.com', 47.890, 1.789, 'Transforming ideas into visually stunning designs', '2023-12-19T19:50:45', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
    ('e0af09ec-7ad6-4c27-b146-b0cc194a9cb3', 'Green Living Landscapes', 'Landscaping', 'Small Business', '789 Eco St', 'Green City', '34567', 0654321098, 'greenliving@example.com', 'Anna Green', 'Landscape Architect', 0789012345, 'anna.green@example.com', 48.321, 1.543, 'Creating sustainable and beautiful outdoor spaces', '2023-12-19T20:40:01', (SELECT Id FROM ValidationStatuses ORDER BY ValidationStatuses.Id OFFSET 2 ROWS FETCH NEXT 1 ROW ONLY)),
